...
#define KG_WINDOW_TITLE                     "PRACTICA 2 - GPO"
#define KG_WINDOW_WIDTH                     600
#define KG_WINDOW_HEIGHT                    400
#define KG_WINDOW_X                         50
#define KG_WINDOW_Y                         50

#define KG_MSSG_SELECT_FILE                 "Ingrese la ruta al archivo: "
#define KG_MSSG_FILENOTFOUND                "Este archivo no existe !!"
#define KG_MSSG_INVALIDFILE                 "Hubo un problema con el archivo ..."
#define KG_MSSG_EMPTYFILE                   "El archivo está vacio"
...
typedef struct elem_Matriz {
    GLfloat M[16];				
    struct elem_Matriz *siguiente; //Siguiente transformación				
    struct elem_Matriz *aptr; //Transformación anterior
} elem_Matriz;
...
struct object3d{
    ...
    struct object3d *next;              //Siguiente objeto
    struct elem_Matriz *pMptr;		    //Puntero a la matriz de transformaciones
};
